...
export default {
  ...
  execute(interaction: ChatInputCommandInteraction) {
    const inviteEmbed = new EmbedBuilder().setTitle(i18n.__mf("🚪 Invite to your server!")).setColor("#0080ff");
    console.log("ID: "+interaction.user.id+" ACTION: cmdInteract.invite");
